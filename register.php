...
if(isset($_POST['submit'])){
   ...
   $cpass = mysqli_real_escape_string($conn, hash('sha256', $_POST['password']));
...
<header id="headere">
    ...
    <li><a  href='register.php?id=$ID'>Add</a></li>
...
<div class="form-container">
   <form action="" method="post">
      <h3> register</h3>
      <input type="text" name="name" required placeholder="user name" class="box"><br>
      ...
      <input type="submit" name="submit" class="btn" value=" confirme"><br>
      <?php
    include('config.php');
    $ID=$_GET['id'];
    $result=mysqli_query($con,"SELECT * FROM corp  WHERE ID = $ID");
    echo"
    <p>you have an account? <a href='login.php?id=$ID'>  Login</a></p>
   ";
   ?>
   </form>
</div>
